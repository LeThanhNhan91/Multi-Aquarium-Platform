...
namespace Aquarium.Application.Interfaces.Posts
{
    public interface IPostService
    {
        ...
        Task<PagedResult<PostFeedDto>> GetStorePostsAsync(Guid storeId, int pageIndex, int pageSize, Guid currentUserId);
        Task<PostFeedDto> GetPostByIdAsync(Guid postId, Guid currentUserId);
