...
namespace Aquarium.Infrastructure.Migrations
{
    ...
    [Migration("20260329080412_AddProductAttributes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid?>("FishInstanceId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.DoaRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("DoaRequests");
                });

            modelBuilder.Entity("Aquarium.Domain.Entities.DoaRequestMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("DoaRequestId");

                    b.ToTable("DoaRequestMedias");
                });
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.FishInstance", b =>
                {
                    ...
                    b.ToTable("FishInstances", (string)null);
                });

            modelBuilder.Entity("Aquarium.Domain.Entities.FishInstanceMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("FishInstanceMedia", (string)null);
                });
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.ProductAttribute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.ProductReviewMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.StoreBadge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("StoreId", "BadgeType")
                        .IsUnique();

                    b.ToTable("StoreBadges");
                });
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.StoreReviewMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("Aquarium.Domain.Entities.FishInstance", "FishInstance")
                        .WithMany()
                        .HasForeignKey("FishInstanceId")
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.DoaRequest", b =>
                {
                    ...
                    b.HasOne("Aquarium.Domain.Entities.User", "ReviewedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.DoaRequestMedia", b =>
                {
                    b.HasOne("Aquarium.Domain.Entities.DoaRequest", "DoaRequest")
                        .WithMany("Media")
                        .HasForeignKey("DoaRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_DoaRequestMedias_DoaRequests");

                    b.Navigation("DoaRequest");
                });

            modelBuilder.Entity("Aquarium.Domain.Entities.FishInstance", b =>
                {
                    b.HasOne("Aquarium.Domain.Entities.Product", "Product")
                        .WithMany("FishInstances")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.InventoryHistory", b =>
                {
                    b.HasOne("Aquarium.Domain.Entities.Inventory", "Inventory")
                        .WithMany("Histories")
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.ProductReviewMedia", b =>
                {
                    b.HasOne("Aquarium.Domain.Entities.ProductReview", "ProductReview")
                        .WithMany("Media")
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.StoreReviewMedia", b =>
                {
                    b.HasOne("Aquarium.Domain.Entities.StoreReview", "StoreReview")
                        .WithMany("Media")
            ...
            modelBuilder.Entity("Aquarium.Domain.Entities.FishInstance", b =>
                {
                    b.Navigation("FishInstanceMedia");
                });
